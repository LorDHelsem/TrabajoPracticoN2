...
public class PrologConector {
	...
	public void crearArchivoPL(String ruta, Inventario inventario, RecetaParser parser) throws IOException {
	    ...
	    for (Receta receta : parser.getRecetas()) {
	        ...
	        for (Map.Entry<Ingrediente, java.lang.Integer> ingrediente : receta.getIngredientes2().entrySet()) {
	            writer.write("ingrediente('" + nombreReceta + "', '" + ingrediente.getKey() + "', " + ingrediente.getValue() + ").\n");
	        }
	    }
